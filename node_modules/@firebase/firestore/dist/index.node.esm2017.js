...
class IndexedDbPersistence {
    ...
    async shutdown() {
        ...
        await this.simpleDb.runTransaction('readwrite', [DbPrimaryClient.store, DbClientMetadata.store], simpleDbTxn => {
...
// Use underscore prefix to hide this class from our Public API.
// eslint-disable-next-line @typescript-eslint/naming-convention
class _SerializableFieldValue {
    constructor() {
        /** A pointer to the implementing class. */
        this._delegate = this;
    }
}
class DeleteFieldValueImpl extends _SerializableFieldValue {
...
class ServerTimestampFieldValueImpl extends _SerializableFieldValue {
    constructor(_methodName) {
        super();
        this._methodName = _methodName;
    }
...
class ArrayUnionFieldValueImpl extends _SerializableFieldValue {
...
class ArrayRemoveFieldValueImpl extends _SerializableFieldValue {
    constructor(_methodName, _elements) {
        super();
        this._methodName = _methodName;
        this._elements = _elements;
...
class NumericIncrementFieldValueImpl extends _SerializableFieldValue {
...
class FieldValue extends _SerializableFieldValue {
    constructor() {
        super();
    }
    static delete() {
...
function parseUpdateData(userDataReader, methodName, targetDoc, input) {
    ...
    forEach(input, (key, value) => {
        ...
        if (value instanceof _SerializableFieldValue &&
